...
import { listActiveTestimonials, testimonialToView } from '@/lib/services/testimonial-service'
    ...
    <Container>
      <div className="grid gap-8 lg:grid-cols-2">
        {testimonials.map((testimonial) => (
          <div
            key={testimonial.id}
            className="border-2 border-outer-space bg-mint-green p-8 shadow-md hover:shadow-xl transition-shadow"
          >
