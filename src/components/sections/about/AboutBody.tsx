          ...
          {useTipTap ? (
            ...
            <div
              className="prose prose-slate prose-lg max-w-none
                ...
                prose-img:w-full prose-img:h-auto prose-img:border-4 prose-img:border-outer-space prose-img:shadow-lg prose-img:my-8
                prose-a:text-jungle-green prose-a:underline hover:prose-a:text-jungle-green
                ...
                return (
                  <article key={section.id || index} className="space-y-6">
                    ...
                    {section.body.slice(0, 2).map((paragraph, paragraphIndex) => (
                      <p key={`${section.id}-${paragraphIndex}`} className="text-lg font-medium text-outer-space leading-relaxed">
                        {paragraph}
                      </p>
                    ))}
                    ...
                    {image && (
                      <figure className="my-8">
                        <img
                          ...
                          className="w-full h-auto border-4 border-outer-space shadow-lg"
                        />
                      </figure>
                    )}
                    ...
                    {section.body.slice(2).map((paragraph, paragraphIndex) => (
                      <p key={`${section.id}-after-${paragraphIndex}`} className="text-lg font-medium text-outer-space leading-relaxed">
                        {paragraph}
                      </p>
                    ))}
                  </article>
